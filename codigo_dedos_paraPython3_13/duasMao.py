...
while True:
    ...
    if hand_landmarks_list:
        for hand_index, landmarks in enumerate(hand_landmarks_list):
            ...
            # Verificação da mão (direita ou esquerda) na nova API
            ...
            # já que a nova API identifica as mãos de forma não espelhada)
            if points[5][0] < points[17][0]:  # Indicador à esquerda do mindinho
                if points[4][0] < points[2][0]:
                    count += 1
            else:  # Indicador à direita do mindinho
                if points[4][0] > points[2][0]:
                    count += 1
            ...
            # Desenho do retângulo e contagem na imagem para a mão atual
